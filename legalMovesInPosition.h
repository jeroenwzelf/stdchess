...
/*
 * Special moves for any position are defined here, and it could provide 
 * as a base for implementing the other legal moves for specific pieces.
 * 
 * @param position: The position to calculate moves in.
*/
